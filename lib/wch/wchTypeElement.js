...
function genImageAcceptType(isJpg, isPng, isGif, isTiff, isSvg, isWebp) { //jshint ignore: line
	var result = [];
...
function genTextElement(key, label, isRequired, min, max, displayType, displayWidth, displayHeight) { //jshint ignore: line
	var result = {};
...
function genVideoAcceptType(isWebm, isOgg, isMpg, isAvi, isMov, isWmv, isMp4) { //jshint ignore: line
	var result = [];
